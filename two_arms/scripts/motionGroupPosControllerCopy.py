...
import numpy as np
import kinematicsUr3 as kin
import kineUr3 as kineUr3

LOOP_RATE = 1000

JOINT_TOPIC = '/robot2/joint_group_position_controller/command'
...
def main():
    ...
    pointPub = Publisher()
    while True:
        pointPub.move([-0.2, -0.2, 0], [-180, 0, 0])
        rospy.sleep(3)
        pointPub.move([0, -0.2, 0], [-180, 0, 0])
        rospy.sleep(3)
